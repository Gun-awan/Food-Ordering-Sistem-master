                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"><center>Rp. <?php echo htmlspecialchars($rows['price']); ?></center></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <center>
                                                        ...
                                                        } elseif ($status == "Sedang Di antar") {
                                                            echo '<button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Sedang Di antar</button>';
                                                        } elseif ($status == "Datang") {
