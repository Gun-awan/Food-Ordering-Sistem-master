...
if (isset($_POST['submit'])) {
    if (
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $mql = "update users set username='$_POST[uname]', f_name='$_POST[fname]', LastUpdatedBy='$LastUpdatedBy', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='$_POST[password]' where u_id='$_GET[user_upd]' ";
            mysqli_query($db, $mql);
