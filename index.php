...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/img/banner_depan.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Food Order Website </h1>
                <h5 class="font-white space-xs">Makanan Khas Indonesia Asli</h5>
                <div class="p-3 steps">
    ...
    <section class="about bg-light p-5">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2 class="title" style="margin-top: 50px;">Tentang Kami</h2>
                <p class="subTitle">Kenali lebih dekat siapa kami dan apa yang kami sajikan</p>
            </div>
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="https://cdn.antaranews.com/cache/1200x800/2024/06/23/Restoran-Nusantara-hidangan-khas-Indonesia-di-Berlin-230624-CLR-1.jpg" alt="Tentang Nusantara" class="img-fluid rounded shadow">
                </div>
                <div class="col-md-6">
                <h4 class="text-center mb-4">Selamat Datang di <span class="text" style="color: rgb(103, 255, 103);">Online Food Ordering</span></h4>

                <p>
                    Kami adalah platform pemesanan makanan yang mengusung cita rasa asli Indonesia.
                    Melalui restoran-restoran khas seperti <strong>Lara Djonggrang</strong>, <strong>Bunga Rampai</strong>, <strong>Harum Manis</strong>, dan <strong>Kembang Goela</strong>, 
                    kami menghadirkan pengalaman kuliner otentik langsung ke meja makan Anda.
                </p>

                <p>
                    Dari resep warisan leluhur hingga cita rasa nusantara yang kaya rempah, setiap hidangan adalah perjalanan rasa dari <em>Sabang sampai Merauke</em>.
                    Kami bekerja sama dengan restoran lokal terpercaya untuk memastikan setiap pesanan tiba dengan cepat, hangat, dan lezat — karena Anda layak mendapatkan yang terbaik.
                </p>
                <div class="text-end mt-3">
                    <a href="about.php" class="btn abouBtn">Pelajari Lebih Lanjut</a>
                </div>
                </div>
            </div>
        </div>
...
<!-- End About Us Section -->
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30" style="margin-top: 50px;">
                <h2 class="title">Produk terlaris bulan ini</h2>
                <p class="subTitle">Hidangan terlaris kami bulan ini</p>
            </div>
            <div class="row">
                    ...
                    echo ' <div class="col-xs-12 col-sm-6 col-md-4 food-item">
										<div class="food-item-wrap box">
											...
											<div class="content">
												...
												<div class="price-btn-block"> <span class="price">Rp ' . number_format($r['price'] * 1000, 0, ',', '.') . '</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '" class="btn ctaBtn  pull-right">Order Now</a> </div>
											</div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 class="title">Our Restaurants</h4>
                        </div>
                    </div>
                    <div class="col-sm-8">
