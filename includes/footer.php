<section class="footerSection">
    <div class="contentContainer container">
        <div class="footerIntro">
            ...
            <p>Nusantara adalah sebuah website yang menawarkan makanan khas indonesia dengan pengiriman makanan via online di restoran favorite mu.</p>
            
            <div class="footContactDetails">
                <div class="info">
                    <div class="iconDiv"><i class='bx bx-mail-send'></i></div>
                    <span>Nusantara@gmail.com</span>
                </div>

                <div class="info">
                    <div class="iconDiv"><i class='bx bxs-phone-outgoing'></i></div>
                    <span>+62 3858394563</span>
                </div>

                <div class="info">
                    <div class="iconDiv"><i class='bx bx-current-location'></i></div>
                    <span>jl.Sudirman, Kota Jakarta</span>
                </div>
            </div>
        </div>
