...
<body>
    ...
    <div class="page-wrapper">
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/bannerdishes.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="widget widget-cart">
                            ...
                            <div class="widget-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group row no-gutter">
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control b-r-0" value=<?php echo "Rp." . $item["price"],000; ?> readonly id="exampleSelect1">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                <p>TOTAL</p>
                                <h3 class="value"><strong><?php echo "Rp." . $item_total.",000";?></strong></h3>
                                <p>Free Shipping</p>
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                All Menu <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                                <span class="price pull-left">Rp.<?php echo $product['price'],000; ?></span>
